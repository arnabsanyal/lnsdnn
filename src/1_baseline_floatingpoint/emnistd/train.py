...
def main(main_params):
	...
	if is_training:
		# load EMNIST digits data and split into train and test sets
		...
		np.savez_compressed('./lin_model_EMNIST_digits.npz', W1=W1, W2=W2, loss_train=performance['loss_train'], \
			acc_train=performance['acc_train'], acc_val=performance['acc_val'])

	else:

		file = np.load('./lin_model_EMNIST_digits.npz', 'r')
		W1 = file['W1']
		W2 = file['W2']
		performance = {}
