...
def main(main_params):
	...
	if is_training:
		# load EMNIST letters data and split into train and test sets
		...
		W2 = np.random.normal(0, 0.1, (101, 26))
		...
		np.savez_compressed('./lin_model_EMNIST_letters.npz', W1=W1, W2=W2, loss_train=performance['loss_train'], \
			acc_train=performance['acc_train'], acc_val=performance['acc_val'])

	else:

		file = np.load('./lin_model_EMNIST_letters.npz', 'r')
		W1 = file['W1']
		W2 = file['W2']
		performance = {}
