...
def main(main_params):
    ...
    if is_training:
        ...
        file = np.load('./../../datasets/emnist_digits.npz', 'r') # dataset
        ...
        np.savez_compressed('./lin_model_EMNIST_digits_1_%d_%d.npz' %(qi - 1, qf), W1=W1, W2=W2, loss_train=performance['loss_train'], \
            acc_train=performance['acc_train'], acc_val=performance['acc_val'])

    else:

        file = np.load('./lin_model_EMNIST_digits_1_%d_%d.npz' %(qi - 1, qf), 'r')
        W1 = file['W1']
        W2 = file['W2']
        performance = {}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--split', default = 200000)
